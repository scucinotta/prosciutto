package com.bedrockframework.plugin.controller
{
	...
	public class EaseScrollerController extends BasicWidget implements IScrollerController
	{
		/*
		...
		*/
		...
		private var _twnContent:TweenMax;
		private var _twnScrubber:TweenMax;
		/*
		Constructor
		*/
		public function EaseScrollerController()
		{
			super();
		}
		/*
		...
		*/
		public function moveContent( $position:Number ):void
		{
			...
			TweenMax.to( this.data, 0.3, { ease:Quad.easeOut, contentPosition:numPosition, overwrite:1 } );
